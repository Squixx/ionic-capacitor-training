...
describe('LoginPage', () => {
  ...
  describe('error messages', () => {
    ...
    it('displays an error message if the password is dirty and empty', () => {
      setInputValue(password, 'test@test.com');
